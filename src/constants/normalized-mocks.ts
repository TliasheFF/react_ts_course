import type { NormalizedDishes, NormalizedRestaurants, NormalizedReviews, NormalizedUsers } from "./normalized-mocks-types";
...
export const normalizedRestaurants: NormalizedRestaurants = [
  ...
  export const normalizedDishes: NormalizedDishes = [
    {
  ...
  export const normalizedReviews: NormalizedReviews = [
    {
  ...
  export const normalizedUsers: NormalizedUsers = [
    {
